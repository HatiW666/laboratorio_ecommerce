import mysql.connector    #ciaoooooooo sono Giorgio yeeeeee
...
def inserisci_saldo_utente(id_utente):
    credito = float(input("Inserisci credito: "))

    q = "UPDATE utenti SET credito = credito + %s WHERE id = %s"
    v = (credito, id_utente)
                ...
                if risultato['ruolo'] == "admin":
                    ...
                    while True:
                        ...
                        if scelta_cliente == 1:
                            ...
                            inserisci_saldo_utente(id_utente)
